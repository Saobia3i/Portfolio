...
const styles = `
    *, *::before, *::after {
    ...
    .project-detail-card::after {
      ...
      width: 65%;
      height: 3px;
      background: linear-gradient(90deg, var(--secondary), rgba(var(--secondary-rgb), 0.3), transparent);
      opacity: 0;
    ...
    .project-detail-card:hover::after { opacity: 1; }
    ...
    .badge-ai     { background: rgba(99,102,241,0.12);  color: #6366f1; border: 1px solid rgba(99,102,241,0.25); }
    .badge-cv     { background: rgba(20,184,166,0.12);  color: #14b8a6; border: 1px solid rgba(20,184,166,0.25); }
    .badge-iot    { background: rgba(245,158,11,0.12);  color: #f59e0b; border: 1px solid rgba(245,158,11,0.25); }
    .badge-full   { background: rgba(59,130,246,0.12);  color: #3b82f6; border: 1px solid rgba(59,130,246,0.25); }
    .badge-fun    { background: rgba(236,72,153,0.12);  color: #ec4899; border: 1px solid rgba(236,72,153,0.25); }
